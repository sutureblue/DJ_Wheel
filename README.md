# DJ_Wheel
DJ Wheel is a hardware–software system that turns a rotary encoder into a digital record player. A physical wheel controls audio playback in real time---forward, backward, and at discrete speeds---using a continuous playhead model inspired by vinyl.

# How It Works
An Arduino Uno reads a rotary encoder and calculates rotation speed (RPM) and direction.
...
It’s designed to feel physical, responsive, and continuous—closer to interacting with a record than pressing buttons on software.
...
# Software
Python (sounddevice, soundfile, numpy, pyserial)
